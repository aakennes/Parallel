...
void ntt_dif_x4_Mint_mpi(Mint *a,Mint *b,Mint *ab,Mint *rt,Mint *irt,int n){
    ...
    ntt_dit_x4_Mint_mpi(a,dw,imag,limit,level,my_rank,threadCounts,initial_w2,mpi_montgomerymodint32_type);
    ntt_dit_x4_Mint_mpi(b,dw,imag,limit,level,my_rank,threadCounts,initial_w2,mpi_montgomerymodint32_type);
	...
	ntt_dif_x4_Mint_mpi(ab,dw,imag,limit,level,my_rank,threadCounts,initial_w2,mpi_montgomerymodint32_type);
